...
Start with the [generator](https://ruagentic.org/generate/) and [specification](https://ruagentic.org/spec/). See [prior work](PRIOR-ART.md) for related techniques and specifications.
