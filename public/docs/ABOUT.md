...
Start with the [generator](https://ruagentic.org/generate/), read the [specification](https://ruagentic.org/spec/), then [audit your files](https://ruagentic.org/audit/). The [integration guide](INTEGRATIONS.md) explains service and client responsibilities.
...
The file generator and local validator run in your browser. The audit reads public files through the hosted service. Hosted recovery tools use isolated synthetic tickets and private reports. See [platform operations](PLATFORM.md) for storage, retention, and runtime details.
...
Open an issue with a concrete use case, a reproducible problem, or a proposed improvement. See [governance](GOVERNANCE.md) and the [compatibility guide](COMPATIBILITY.md) for contribution and implementation checks.
