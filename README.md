...
Install the [CLI from npm](https://www.npmjs.com/package/ruagentic/v/0.1.0-draft.5) with `npm install -g ruagentic@0.1.0-draft.5` (Node 24+), then run `agentic`. See [Get started](https://ruagentic.org/adopt/) for generation, validation, and agent connections.
