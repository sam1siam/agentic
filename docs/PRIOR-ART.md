...
Research checked September 7, 2026. These projects and proposals have different scopes and maturity levels; inclusion is not an adoption or endorsement claim.
...
- [WebMCP draft](https://webmachinelearning.github.io/webmcp/): structured tools in web applications.
...
Agentic does not claim invention of idempotency, status reconciliation, receipts, or verification. The proposal is a narrow shared profile and reproducible behavioral tests. Whether that deserves a separate file, an Arazzo extension, or another integration should be decided with implementers.
