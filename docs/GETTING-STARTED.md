...
The generator includes README.md and portable LISTING.md text automatically. Merge README sections into your project documentation and publish a raw copy beside the Agentic files, or provide its URL when auditing. The audit reports successful, partial, or failed publication with specific remedies. [Publication guide](PUBLICATION.md).
