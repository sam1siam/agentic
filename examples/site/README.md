...
Public documentation and API resources for an example website.

Website: [https://service.example](https://service.example/)

## Agentic files

- [agentic.json](https://service.example/agentic.json) — structured site information.
- [agentic.txt](https://service.example/agentic.txt) — readable index with specification and directory references.

This Site Profile 1.1.0 indexes 2 public resources and 0 documented API operations. Resource records distinguish documents that were read from connections that were only advertised.

## Documentation and connections

- [documentation](https://service.example/docs) — documentation; document retrieved.
- [mcp](https://service.example/mcp) — mcp; advertised link; connection not tested.
