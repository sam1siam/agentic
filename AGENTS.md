...
Read docs/SPEC.md, docs/SITE-PROFILE.md, and docs/PUBLICATION.md before changing protocol behavior. Site Profile 1.1.0, Action Profile 1.0.0, and tools 1.3.0 are the current releases; preserve published requirements and version compatibility explicitly.
